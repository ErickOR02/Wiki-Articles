  ...
  return (
    <div className={styles.module}>
      ...
      style={{ cursor: 'pointer' }}>
        ...
        <p><a onClick={() => {navigate('/articles/como-ajustar-datos-cuenta-y-contraseña')}}>
        ¿Cómo ajustar tus datos de tu cuenta y cambiar tu contraseña? 
        </a></p>  
        <p><a onClick={() => {navigate('/articles/como-agregar-y-configurar-alertas')}}>
        ¿Como configurar y agregar alertas?
        </a></p> 
        <p><a onClick={() => {navigate('/articles/como-configurar-mi-suscripción')}} >
