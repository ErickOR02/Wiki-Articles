...
import AgregarComnt0 from '../../assets/Imagenes-articulos/M-Alertas/Como ver una alerta/Agregar comentario 0.png'
...
function ArticuloCVUA() { 
    return (
      <>
        ...
        <h1 className='text-center'>Como ver una alerta, atenderla y agregar comentarios? </h1>
        ...
        <h2 className='ml-48'> <strong> Contenido del artículo </strong> </h2>
        ...
        <p className='ml-48'> <strong>¿Cómo ver una alerta?</strong></p>
        <p className='ml-48'> <strong>Pasos</strong></p>
        <p className='ml-48'> <strong>Paso 1: </strong> Ve a tu módulo de alertas, aquí podrás encontrar las alertas agrupadas por viaje, una vez aquí darás clic <br />
        al viaje con la alerta que quieras ver.</p>
        <img src={VerAlerta1} alt="" 
        className='mx-auto w-[700px] h-[500px]' /> <br />
        <p className='ml-48'><strong>Paso 2: </strong>En la parte derecha del módulo podrás ver las diferentes alertas que se han registrado al viaje, da clic en <br />
        “Ver alerta” para que Tramo te muestre una nueva ventana con la información de esta. </p>
        <p className='ml-48'> Aquí podrás ver toda la información de la alerta registrada, desde las coordenadas en las que se registró la alerta <br />
        hasta la fecha en la que pasó, la fecha en la que se le dio atención, el tiempo de la reacción y por quien fue atendida <br />
        la alerta. </p>
        <img src={VerAlerta2} alt="" 
        className='mx-auto w-[700px] h-[500px]' /> <br /> 
        <p className='ml-48'><strong>¿Cómo atender una alerta?</strong></p>
        <p className='ml-48'> <strong> Pasos </strong> </p>
        <p className='ml-48'><strong>Paso 1: </strong> Sígue los mismos pasos de "¿Cómo ver una alerta? <br /> </p>        
        <p className='ml-48'><strong>Paso 2: </strong> Paso 2: Una vez estes en la alerta, podrás ver un botón “Atender alerta” en la esquina inferior derecha, haz clic <br />
        en él y te llevará a la siguiente ventana.  </p>        
        <img src={Boton} alt="" 
        className='mx-auto w-[300px] h-[100px]' /> <br />
        <p className='ml-48'> Aquí te pedirá la siguiente información </p>
        ...
        <ul className="ml-48 list-decimal list-inside">
          <li className="mb-2">Escalar alerta: Te permitirá hacer una escalación, llevando esta alerta a niveles superiores para que ellos se encarguen de <br />
        ...
        className='mx-auto w-[300px] h-[100px]' /> <br />
          ...
          <li className="mb-2">Atender alerta: Al dar clic a esta opción, darás la alerta como atendida y se mostrará completada con todos los datos que <br />
          hayas puesto. </li>
          <div className='flex mr-64' >
        ...
        <p className='ml-48'><strong> Paso 2: </strong> Al llegar a las pestañas de la alerta donde queramos agregar el comentario, haz clic en la pestaña “Comentarios”. </p>
        <p className='ml-48'><strong> Paso 3: </strong> Paso 3: Haz clic en “agregar comentario”, te aparecerá una nueva ventana donde podrás agregar la información <br />
        para poder hacer la adicción.  </p>
        <p className='ml-48'> La información que debes llenar es: </p>
        <ol className="ml-48 list-decimal list-inside">
          <li className="mb-2">Ubicación</li>
          <li className="mb-2">Observaciones</li>
          <li className="mb-2">Estatus</li>
