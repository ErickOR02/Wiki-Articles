...
import Pestañas from '../../assets/Imagenes-articulos/M-Viajes/Como esta organizada la información/Pestañas.png'
    ...
    return (
      <>
        ...
        <ol className='ml-48 list-decimal list-inside'>  
          <li>  {/* 1 */} 
          Aquí podrás crear un nuevo viaje y poder agregarlo al módulo de viaje.
          <img src={Button} alt="" 
          ...
          viajes que cuentan con alertas, viajes programados, viajes en ruta, viajes finalizados.
          <img src={Tabs} alt="" 
          ...
          <li>  {/* 3 */}
          Aquí podrás hacer una búsqueda sobre un viaje.
          <img src={SearchBar} alt="" 
          className=' w-[800px] h-[40px]' />
          </li> <br />

          <li>  {/* 4 */}
          Aquí podrás acceder a los filtros del módulo de viajes, podrás elegir cuales se mostrarán, cual agregar y cual quitar. 
          <img src={FilterBttn} alt="" 
          className=' w-[150px] h-[40px]' />
          </li> <br />
          
          <li>  {/* 5 */}
          Aquí podrás ordenar los viajes de tu módulo de viajes para tener la información ordenada a tu gusto.  
          ...
          <li>  {/* 6 */}
          Aquí podrás acceder a la información interna del viaje, bitácora, alertas, rutas, etc.
          <img src={ViajeInfo} alt="" 
          className=' w-[400px] h-[150px]' />
          </li> <br />

          <li>  {/* 7 */}
          Aquí podrás ajustar cuantos viajes se mostrarán en una sola página.  
          <img src={Emptybttn} alt="" 
          className=' w-[200px] h-[40px]' />   
          </li> <br />

          <li>  {/* 8 */}
          Aquí podrás cambiar la página de tu módulo de viajes por si el viaje que buscas no está en la primera página. 
